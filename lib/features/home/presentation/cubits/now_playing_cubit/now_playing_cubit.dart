...
import 'package:movie_nti_aug/features/home/data/models/now_playing_model.dart';
...
class NowPlayingCubit extends Cubit<NowPlayingState> {
  ...
  void getNowPlaying() async{
    ...
    try{
      ...
      print(res.data);
      var response = NowPlayingMovieResponse.fromJson(res.data);
      emit(NowPlayingSuccess(movies:response.results));
    } catch (e) {
      emit(NowPlayingFailure(message: e.toString()));
    }
  }
}
